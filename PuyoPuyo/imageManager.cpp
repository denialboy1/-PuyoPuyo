...
void  imageManager::alphaFrameRender(string strKey, HDC hdc, int destX, int destY)
{
	image* img = findImage(strKey);
...
void  imageManager::alphaFrameRender(string strKey, HDC hdc, int destX, int destY, int currentFrameX, int currentFrameY)
{
	image* img = findImage(strKey);
